...
export function AudioPlayer({ song, isExpanded, currentLyric, playingPercentage, onClick }: AudioPlayerProps) {
    return (
        <div
            className={clsx("song-card", isExpanded && "expanded")}
            onClick={onClick}
        >
            <div className="song-cover">
                <AlbumCover albumId={song.cover} />
            </div>
            <div className="song-content">
                ...
                <div className="song-lyrics">{isExpanded ? currentLyric : "no lyrics"}</div>
            </div>
