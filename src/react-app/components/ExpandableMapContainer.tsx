...
const ExpandableMapItem =
    ({ item, index, nInView, setNInView, renderItem }: ExpandableMapItemProps<any>) => {
...
export const ExpandableMapContainer = React.forwardRef<
    HTMLDivElement,
    ExpandableMapContainerProps<any>
>(
    (
        {
            items,
