...
export const actors_by_fraction: {
    ...
    astral_express: [
        ...
        { id: "pom-pom", name: "帕姆", va: "蒋丽", rarity: "EX" },
        { id: "sunday", name: "星期日", va: "徐翔", rarity: "EX" },
    ],
    stellaron_hunters: [
        { id: "elio", name: "艾利欧", rarity: "Ω" },
    ...
    aeon: [
        { id: "aha", name: "阿哈", rarity: "Ω" },
        { id: "akivili", name: "阿基维利", rarity: "Ω" },
        { id: "ena", name: "太一", rarity: "Ω" },
        { id: "fuli", name: "浮黎", rarity: "Ω" },
        { id: "hooh", name: "互", rarity: "Ω" },
        { id: "IX", name: "Ⅸ", rarity: "Ω" },
        { id: "idrila", name: "伊德莉拉", rarity: "Ω" },
        { id: "lan", name: "岚", rarity: "Ω" },
        { id: "long", name: "龙", rarity: "Ω" },
        { id: "mythus", name: "迷思", rarity: "Ω" },
        { id: "nanook", name: "纳努克", rarity: "Ω" },
        { id: "nous", name: "博识尊", rarity: "Ω" },
        { id: "oroboros", name: "奥博洛斯", rarity: "Ω" },
        { id: "qlipoth", name: "克里珀", rarity: "Ω" },
        { id: "tayzzyronth", name: "塔伊兹育罗斯", rarity: "Ω" },
        { id: "terminus", name: "末王", rarity: "Ω" },
        { id: "xipe", name: "希佩", rarity: "Ω" },
        { id: "yaoshi", name: "药师", rarity: "Ω" },
    ],
    genius_society: [
        {
            id: "the-herta",
    ...
    lord_ravager: [
        { id: "phantylia", name: "幻胧", va: "", rarity: "EX" },
        { id: "archforger", name: "铸王", va: "", rarity: "EX" },
        { id: "asat-pramad", name: "归寂", va: "", rarity: "EX" },
        { id: "celenova", name: "星啸", va: "", rarity: "EX" },
        { id: "luxbane", name: "光逝", va: "", rarity: "EX" },
        { id: "zephyro", name: "焚风", va: "", rarity: "EX" },
        { id: "irontomb", name: "铁墓", va: "", rarity: "EX" },
        { id: "zulo", name: "诛罗", va: "", rarity: "EX" },
    ...
    garden_of_recollection: [{ id: "black-swan", name: "黑天鹅", va: "杨梦露", rarity: "EX" }],
    intelligentsia_guild: [{ id: "dr-ratio", name: "真理医生", va: "桑毓泽", rarity: "S" }],
    knights_of_beauty: [{ id: "argenti", name: "银枝", va: "梁达伟", rarity: "S" }],
    self_annihilators: [{ id: "acheron", name: "黄泉", va: "菊花花", rarity: "EX", favorite: true }],
    penacony: [
    ...
    the_cremators: [{ id: "the-dahlia", name: "大丽花", va: "阮从青", rarity: "S" }],
    masked_fools: [
    ...
    belobog: [
        ...
        { id: "cocolia", name: "可可利亚", va: "", rarity: "A" },
        ...
        { id: "svarog", name: "史瓦罗", va: "王宇航", rarity: "A" },
...
export const legends = [
    ...
    },
    {
        label: "紫晶级",
        code: "A",
        description: "在特定事件或阶段中扮演重要角色。<br/>他们的选择能够显著影响局部进程，却难以独立改变历史大势。",
    },
    {
        label: "路人级",
        code: "NPC",
        description: "未被判定为变量，仅作为时代背景与社会样本被记录。<br/>他们的行为在宏观层面不构成影响，无关紧要。",
    },
];
...
export const favorite_actors: Actor[] = Object.values(
    Object.entries(actors_by_fraction)
        .flatMap(([fraction, list]) => list.filter((a) => a.favorite).map((a) => ({ ...a, tags: [fraction] })))
        .reduce<Record<string, any>>((acc, a) => {
            acc[a.id] ??= { ...a, tags: [] };
            acc[a.id].tags.push(...a.tags);
            return acc;
