...
const videos: VideoEntry[] = [
    {
        id: "Fables About the Stars Part 1",
        title: "有关星空的寓言集•其一",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1EM4y1h7Vm/",
        img: { cover: "/animated_short_cover/BV1EM4y1h7Vm.jpg" },
        display: false,
        description:
            "「无数流星划过今夜的天空…如果选中了正确的那一颗，它将把你的愿望带向千百个世界。」\r\n\r\n中文CV：\r\n「忆者」黑天鹅——杨梦露\r\n\r\n日文CV：\r\n「忆者」黑天鹅——生天目仁美\r\n\r\n英文CV：\r\n「忆者」黑天鹅——Arryn Zech\r\n\r\n韩文CV：\r\n「忆者」黑天鹅——김하영",
    },
    {
        id: "History of the Xianzhou: Seven Arbiter-Generals",
        title: "仙舟通鉴•帝弓七天将",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV19o4y1x7tX/",
        img: { cover: "/animated_short_cover/BV19o4y1x7tX.jpg" },
        display: false,
        description:
            "星汉做关河，张弓奏棹歌。\r\n军锋和金柝，破阵仗神戈。\r\n前途迢递孱颜险，旌旆蔽天讨寿魔。\r\n\r\n中文CV：\r\n公输师傅——邹亮\r\n景元——孙晔\r\n罗刹——赵路\r\n\r\n日文CV：\r\n公输师傅——近藤浩德\r\n景元——小野大辅\r\n罗刹——石田彰\r\n\r\n英文CV：\r\n公输师傅——Michael Sorich\r\n景元——Alejandro Saab\r\n罗刹——Craig Lee Thomas\r\n\r\n韩文CV：\r\n公输师傅——김용\r\n景元——류승곤\r\n罗刹——신용우",
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV16g4y157Zc.jpg" },
        display: true,
        description:
    ...
    {
        id: "The Jepella Rebellion — Scene 47",
        title: "耶佩拉叛乱：第47场",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1Nu411H7C6/",
        img: { cover: "/animated_short_cover/BV1Nu411H7C6.jpg" },
        display: false,
        description:
            "第47场。\n内景。耶佩拉宫——黄昏。毁灭。\n女人微笑着看向审判席，迎接他们的判词……\n\n中文CV：\n卡芙卡——徐慧\n萨姆——淦子齐\n耶佩拉罚判者——赵梓涵\n\n日文CV：\n卡芙卡——伊藤静\n萨姆——笠间淳\n耶佩拉罚判者——藤井启辅\n\n英文CV：\n卡芙卡——Cheryl Texiera\n萨姆——Adin Rudd\n耶佩拉罚判者——Steven Kelly\n\n韩文CV：\n卡芙卡——사문영\n萨姆——장서화\n耶佩拉罚判者——장서화",
    },
    {
        id: "History of the Xianzhou- Exodus of the Five Dragons",
        title: "仙舟通鉴•五龙远徙",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1nu4y1D7Ex/",
        img: { cover: "/animated_short_cover/BV1nu4y1D7Ex.jpg" },
        display: false,
        description:
            "「祂绘出一个完美的圆，如命运般周而复始，从来处来，到去处去。」\n\n中文CV：\n「龙师」涛然——许棕哲\n「执笔者」奥本海默——李程远\n\n日文CV：\n「龙师」涛然——上别府仁资\n「执笔者」奥本海默——伊藤有希\n\n英文CV：\n「龙师」涛然——Daman Mills\n「执笔者」奥本海默——Frank Todaro\n\n韩文CV：\n「龙师」涛然——김용\n「执笔者」奥本海默——구지원",
    },
    {
        id: "Ichor of Two Dragons",
        title: "玄黄",
        genre: "动画短片",
        url: "https://www.bilibili.com/video/BV1Th4y1S7KF/",
        img: { cover: "/animated_short_cover/BV1Th4y1S7KF.jpg" },
        display: true,
        description:
    ...
    {
        id: "Cloud Knights Martial Doctrine, On Swords",
        title: "云骑武经•说剑",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV12N4y1o7ET/",
        img: { cover: "/animated_short_cover/BV12N4y1o7ET.jpg" },
        display: false,
        description:
            "「『直之无前，举之无上，案之无下，运之无旁。上决浮云，下绝地纪。』…这便是我汲汲所求的剑。」\n「可这样的剑，世间真的存在吗？」\n\n剑，长三尺七寸，轻如无物。\n它并非凡铁熔铸，而是一截坚冰凝成，幽幽含光，如握一线月光在手。\n中文CV：\n镜流——杜冥鸦\n彦卿——喵酱\n\n日文CV：\n镜流——桑岛法子\n彦卿——井上麻里奈\n\n英文CV：\n镜流——AmaLee\n彦卿——Amber May\n\n韩文CV：\n镜流——박이서\n彦卿——이새아",
    },
    {
        id: "Interastral Peace Tour: Selection, Planning, and Opportunity",
        title: "星际和平导览：甄选、规划和机遇",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1ny4y1P7SN/",
        img: { cover: "/animated_short_cover/BV1ny4y1P7SN.jpg" },
        display: false,
        description:
            "嘿，你！没错，我们正在找你。\r\n琥珀王的巨锤已经落下，无人能够置身事外……\r\n\r\n中文CV：\r\n叽米——刘北辰\r\n\r\n日文CV：\r\n叽米——名村幸太朗\r\n\r\n英文CV：\r\n叽米——Bill Butts\r\n\r\n韩文CV：\r\n叽米——강호철",
    },
    {
        id: "An Exorcism at Fyxestroll Garden",
        title: "绥园伏鬼记",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1Xw411K7Mg/",
        img: { cover: "/animated_short_cover/BV1Xw411K7Mg.jpg" },
        display: false,
        description:
            "世间如有恶鬼出现，十王判官便会下山擒伏。\n执旗呼号，书符降召，以驱赶鬼怪邪恶，保生灵平安。\n且说那日，小小判官接了法旨，要受命伏魔……\n\n中文CV：\n尾巴——刘北辰\n藿藿——葛子瑞\n小道士（藿藿 饰演）——葛子瑞\n僵尸（雪衣 饰演）——溯浔\n女鬼（寒鸦 饰演）——张雨曦\n\n\n日文CV：\n尾巴——平林刚\n藿藿——长绳麻理亚\n小道士（藿藿 饰演）——长绳麻理亚\n僵尸（雪衣 饰演）——河濑茉希\n女鬼（寒鸦 饰演）——铃代纱弓\n\n英文CV：\n尾巴—— Adam Michael Gold\n藿藿——Courtney Lin\n小道士（藿藿 饰演）——Courtney Lin\n僵尸（雪衣 饰演）——Jenny Yokobori\n女鬼（寒鸦 饰演）——Suzie Yeung\n\n韩文CV：\n尾巴——한복현\n藿藿——김채린\n小道士（藿藿 饰演）——김채린\n僵尸（雪衣 饰演）——박리나\n女鬼（寒鸦 饰演）——윤은서",
    },
    {
        id: "Transcendent Ruan Tunes, Blushing Mei Blooms",
        title: "阮声落华裳，梅出似点妆",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1pb4y1V7Qw/",
        img: { cover: "/animated_short_cover/BV1pb4y1V7Qw.jpg" },
        display: false,
        description:
            "煮水沁眉，绣枕华发，轻拢微火烤，\r\n烤那信中淡意多多，浓情少少。\r\n落笔点枝，湖水蘸绿，\r\n她抹去一指琼绸碎玉，冰雪玎玲，\r\n旧章皆烬。\r\n\r\n中文CV：\r\n阮•梅——张文钰\r\n\r\n日文CV：\r\n阮•梅——大西沙织\r\n\r\n英文CV：\r\n阮•梅——Emi Lo\r\n\r\n韩文CV：\r\n阮•梅——윤여진",
    },
    {
        id: "A Night of Ever-Flame: Scene 33",
        title: "永火一夜：第33场",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1UK411e7tY/",
        img: { cover: "/animated_short_cover/BV1UK411e7tY.jpg" },
        display: false,
        description:
            "第33场。\n内景。永火官邸——夜。毁灭。\n炽热的火焰说道：「美梦燃烧了我的花朵，我的死亡。」\n\n中文CV：\n冥火大公——孟祥龙\n「调音师」阿卡什——赵梓涵\n「书吏」杜布拉——苏子芜\n「枷锁」卡翠娜——李蝉妃\n「大丽花」康士坦丝——阮从青\n\n日文CV：\n冥火大公——丹泽晃之\n「调音师」阿卡什——新垣樽助\n「书吏」杜布拉——野口瑠璃子\n「枷锁」卡翠娜——三瓶由布子\n「大丽花」康士坦丝——佐佐木未来\n\n英文CV：\n冥火大公——Bob Johnson\n「调音师」阿卡什——Talon Warburton\n「书吏」杜布拉——Kayli Mills\n「枷锁」卡翠娜——Arianna Ratner\n「大丽花」康士坦丝——Jennifer Losi\n\n韩文CV：\n冥火大公——이주승\n「调音师」阿卡什——백승철\n「书吏」杜布拉——김이안\n「枷锁」卡翠娜——이새벽\n「大丽花」康士坦丝——김도희",
    },
    {
        id: "A Revisiting of Past Dreams",
        title: "旧梦重温",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1FZ421z7PE/",
        img: { cover: "/animated_short_cover/BV1FZ421z7PE.jpg" },
        display: false,
        description:
            "一件失物，一声巨响，一缕冥火……\n记忆的洪流奔涌而过，盈满整座星球\n——在盛会开始前，有些秘密已被沉入海底。\n\n中文CV：\n黑天鹅——杨梦露\n知更鸟——钱琛 \n\n日文CV：\n黑天鹅——生天目仁美\n知更鸟——名冢佳织\n\n英文CV：\n黑天鹅——Arryn Zech\n知更鸟——Alice Himora\n\n韩文CV：\n黑天鹅——김하영\n知更鸟——신온유",
    },
    {
        id: "Sparkle: Behind the Curtain",
        title: "《花火》：幕后纪录",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1cC411W7pH/",
        img: { cover: "/animated_short_cover/BV1cC411W7pH.jpg" },
        display: false,
        description:
            "当你察觉这只是一场戏，便想离开这个舞台……\r\n却发现《花火》的舞台之外，什么也没有。\r\n\r\n中文CV：\r\n花火——赵爽\r\n\r\n日文CV：\r\n花火——上田丽奈\r\n\r\n英文CV：\r\n花火——Lizzie Freeman\r\n\r\n韩文CV：\r\n花火——성예원",
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1aC411h7e6.jpg" },
        display: true,
        description:
    ...
    {
        id: "Kyoden: A Cleave Across the Transient World",
        title: "虚谭•浮世三千一刀缭断",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV16m411R78H/",
        img: { cover: "/animated_short_cover/BV16m411R78H.jpg" },
        display: false,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1fx4y147PH.jpg" },
        display: false,
        description:
            "「你还是个孩子的时候，也尝试过投石入水，并乐在其中吧？」\n「那有没有想过，既然涟漪总会散去，我们到底是为了什么才丢出石头？」\n「答案很简单。只有投石者才清楚，丢下的石子会荡开怎样的波澜——而水面上的倒影，又会因此扭曲出怎样的快乐。」\n\n中文CV：\n花火——赵爽\n\n日文CV：\n花火——上田丽奈\n\n英文CV：\n花火——Lizzie Freeman\n\n韩文CV：\n花火——성예원",
    },
    {
        id: "Stoneheart's Oath Ring: Both Ends of the Scale",
        title: "石心誓环•天平两端",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1xE4m1R78a/",
        img: { cover: "/animated_short_cover/BV1xE4m1R78a.jpg" },
        display: false,
        description:
            "战略投资部的主管「钻石」极少公开露面，代替其人站在台前的是名为「石心十人」的团体。\n而在关乎团队生存的重大议题上，「钻石」则允许十位精英以独立、平等的方式完成决策，即投票表决。\n琥珀、玛瑙、托帕、舒俱、砂金、真珠、苍刚、翡翠、龙晶、欧泊——\n而今，一枚基石破碎，砝码仅余其九。下一个被摆上台桌的问题，只能以「倾倒」作结……\n‍\n中文CV：\n真珠——苏婉\n砂金——杨超然\n舒俱——唐子晰\n托帕——陆敏悦\n翡翠——张若瑜\n龙晶——洪海天\n欧泊——Kinsen\n‍\n日文CV：\n真珠——安野希世乃\n砂金——河西健吾\n舒俱——高桥广树\n托帕——南条爱乃\n翡翠——三石琴乃\n龙晶——上坂堇\n欧泊——岸尾大辅\n‍\n英文CV：\n真珠——Cat Protano\n砂金——Camden Sutkowski\n舒俱——AJ Beckles\n托帕——Sam Slade\n翡翠——Faye Mata\n龙晶——Erin Yvette\n欧泊——Paul Castro Jr.\n‍\n韩文CV：\n真珠——여윤미\n砂金——박준원\n舒俱——홍범기\n托帕——방시우\n翡翠——김순미\n龙晶——강새봄\n欧泊——정의택",
    },
    {
        id: "Mind the Swelter, Watch the Furnace",
        title: "天干剑燥，小心火炉",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1xi421a7mg/",
        img: { cover: "/animated_short_cover/BV1xi421a7mg.jpg" },
        display: false,
        description:
            "且说那熔兵剑炉所在之处，偶有浓烈火光，混有无言寂静的哀嚎残响。\n‌\n「叫破喉咙也不会有人理你的，魔剑。」\n「破喉咙、破喉咙……」\n‍\n中文CV：\n云璃——刘雯\n怀炎——李昊甲\n‍\n日文CV：\n云璃——若山诗音\n怀炎——宫泽正\n‍\n英文CV：\n云璃——Brenna Larsen\n怀炎——J. Michael Tatum\n‍\n韩文CV：\n云璃——이주은\n怀炎——조민수",
    },
    {
        id: "The Arrow that Seeks the Stars",
        title: "飞镝追星",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1TT421z7e3/",
        img: { cover: "/animated_short_cover/BV1TT421z7e3.jpg" },
        display: false,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1ZBzhYREVs.jpg" },
        display: false,
        description:
            "一只鸟盘旋梦中，一只鸟飞向天空。\n一只鸟扇动双翅，一只鸟闭目低头。\n \n「愿你的天空永远星光灿烂。」\n \n中文CV：\n星期日——徐翔\n知更鸟——钱琛\n \n日文CV：\n星期日——大冢刚央\n知更鸟——名冢佳织\n \n英文CV：\n星期日——Griffin Puatu\n知更鸟——Alice Himora\n \n韩文CV：\n星期日——강성우\n知更鸟——신온유",
    },
    {
        id: "Unlike a Floating Cloud",
        title: "不似一片浮云",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV12xkMYjEio/",
        img: { cover: "/animated_short_cover/BV12xkMYjEio.jpg" },
        display: false,
        description:
            "她的生命并非一声巨响，也非一阵呜咽。\n在那条「向生」或「毁灭」的择路中，她听见了自己的声音——\n「向前去吧，切莫回头。」\n \n「这星海间万千世界，我还远远未看够呢……」\n \n中文CV：\n阮•梅——张文钰\n停云——蒋丽\n \n日文CV：\n阮•梅——大西沙织\n停云——高田忧希\n \n英文CV：\n阮•梅——Emi Lo\n停云——Anya Floris\n \n韩文CV：\n阮•梅——윤여진\n停云——이명호",
    },
    {
        id: "Stars, Silent as Enigmas",
        title: "群星静默如谜",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1dCr3YqEtT/",
        img: { cover: "/animated_short_cover/BV1dCr3YqEtT.jpg" },
        display: false,
        description:
            "解答1+1=2的那一分钟\n推翻等号必然存在的那一分钟\n白昼黑夜发生规律的那一分钟\n吸气与呼气停止交替的那一分钟\n生命的第六十一秒发生的那一分钟\n恒星闪耀与熄灭后静默的那一分钟\n \n无数的「问题」在宇宙闪烁，唯有生命才能将好奇浇熄。\n \n中文CV：\n黑塔——侯小菲\n \n日文CV：\n黑塔——山崎遥\n \n英文CV：\n黑塔——PJ Mattson\n \n韩文CV：\n黑塔——김서영",
    },
    {
        id: "T H E H E R T A'S M A G I C K I T C H E N",
        title: "大 黑 塔 的 魔 法 厨 房",
        genre: "动画短片",
        url: "https://www.bilibili.com/video/BV1cErqYDEGC/",
        img: { cover: "/animated_short_cover/BV1cErqYDEGC.jpg" },
        display: false,
        description:
            "在世人难以探索到的宇宙边境，一位天才开始思考……\n「如果42个魔法都无法做出一块令人闻到其香就感到幸福、不自觉微笑的蛋糕……」\n「那么足以证明，这是一项还未被研究透彻的科学理论。」\n \n中文CV：\n黑塔——侯小菲\n阮•梅——张文钰\n \n日文CV：\n黑塔——山崎遥\n阮•梅——大西沙织\n \n英文CV：\n黑塔——PJ Mattson\n阮•梅——Emi Lo\n \n韩文CV：\n黑塔——김서영\n阮•梅——윤여진",
    },
    {
        id: "Amphoreus' Saga of Heroes",
        title: "翁法罗斯英雄纪",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1GeUUYREXy/",
        img: { cover: "/animated_short_cover/BV1GeUUYREXy.jpg" },
        display: false,
        description:
    ...
    {
        id: "The First Dawn of Destiny",
        title: "命运的第一个黎明",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1sZAnevEsh/",
        img: { cover: "/animated_short_cover/BV1sZAnevEsh.jpg" },
        display: false,
        description:
            "天空划过晦暗的闪电。\n最初的半神到达群山之巅，聆听命运的谏言。\n最末的流星划破永夜，成为抵御厄运的刀剑。\n \n彼时的他们仍在等候：\n或是一颗韬光养晦的棋子，\n一首浪的余音，\n一截尚未缝纫的裙摆，\n一枚双面不一的金币。\n或是一只停在枝头的蝶，\n一句悖谬的抗言，\n一缕温暖的微光，\n一头迁徙的狮子，\n一把无名的剑。\n……\n \n开启「门径」的黄金裔，\n你的灵魂必遭歧路分离\n——但黎明将要到来。\n \n中文CV：\n缇里西庇俄丝——蔡书瑾\n \n日文CV：\n缇里西庇俄丝——远野光\n \n英文CV：\n缇里西庇俄丝——Hayden Daviau\n \n韩文CV：\n缇里西庇俄丝——방연지",
    },
    {
        id: "The Long Night of Serenity",
        title: "那安息的长夜",
        genre: "动画短片",
        url: "https://www.bilibili.com/video/BV16io9YTEqH/",
        img: { cover: "/animated_short_cover/BV16io9YTEqH.jpg" },
        display: true,
        description:
            "穿戴起令生命止步的王冠\n死神也钟爱于低垂的眼帘\n行过欢送的宫殿\n与亡者的世界相连\n \n在寒溟与葬仪声中\n夜以继日地\n俯身在这片雪土\n成为此处唯一的歌\n \n所有的叹息都从她的指尖涌出\n所有的慰语都因她的手被阻隔\n所有的恸哭都被她吞咽在掌心\n \n——写作名为「哀地里亚的圣女」的诗\n \n中文CV：\n遐蝶——阮从青\n \n日文CV：\n遐蝶——斋藤千和\n \n英文CV：\n遐蝶——Melody Muze\n \n韩文CV：\n遐蝶——이세레나",
    },
    {
        id: "Life Awakens from the Night",
        title: "生命从夜中醒来",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV18hZ1YaEuM/",
        img: { cover: "/animated_short_cover/BV18hZ1YaEuM.jpg" },
        display: false,
        description:
            "在触碰与离别之间\n我看到，世间的\n风雪在掌心间融化\n神明在春天闭上眼\n \n我知道，他们的\n遗憾在拥抱后温存\n苦难在爱情里燃烧\n哀悼在世界下喧嚣\n \n我听见，他们说\n为了反抗不断垂下的手\n为了反抗浸透悲哀的黄金\n为了反抗没有语言的黑水\n \n为了反抗死亡，他们歌唱\n为了持存记忆的生命歌唱\n歌唱通往遥远花海的航线\n说，命运就该从那里离去\n \n『我也想伸出双手』\n只因我想恳求，请不要\n不要停留在，触碰与离别的瞬息\n \n——那名为「遐蝶」的诗，将由何人来写作\n \n中文CV：\n遐蝶——阮从青\n阿格莱雅——楚越\n缇宝——蔡书瑾\n那刻夏——钱文青\n白厄——秦且歌\n万敌——赵成晨\n风堇——静宸\n赛飞儿——王雅欣\n \n日文CV：\n遐蝶——斋藤千和\n阿格莱雅——远藤绫\n缇宝——远野光\n那刻夏——内田雄马\n白厄——日野聪\n万敌——阿座上洋平\n风堇——羊宫妃那\n赛飞儿——伊藤彩沙\n \n英文CV：\n遐蝶——Melody Muze\n阿格莱雅——Morgan Lauré\n缇宝——Hayden Daviau\n那刻夏——Stephen Fu\n白厄——Joshua Waters\n万敌——Gabriel Warburton\n风堇——Holly Earl\n赛飞儿——Shea Fairaday\n \n韩文CV：\n遐蝶——이세레나\n阿格莱雅——오로아\n缇宝——방연지\n那刻夏——이상준\n白厄——윤용식\n万敌——안효민\n风堇——김연우\n赛飞儿——미소",
    },
    {
        id: "Fables About the Stars Part 2",
        title: "有关星空的寓言集•其二",
        genre: "千星纪游",
        url: "https://www.bilibili.com/video/BV1HsKbznEZg/",
        img: { cover: "/animated_short_cover/BV1HsKbznEZg.jpg" },
        display: false,
        description:
    ...
    {
        id: "Hark! There's Revelry Atop the Divine Mountain",
        title: "听！狂欢在那神佑的山巅",
        genre: "动画短片",
        url: "https://www.bilibili.com/video/BV1twgSzhEo8/",
        img: { cover: "/animated_short_cover/BV1twgSzhEo8.jpg" },
        display: true,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1uopiz8E9B.jpg" },
        display: false,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1BpJrz7EUL.jpg" },
        display: true,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1R5JyzJE9Y.jpg" },
        display: false,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1xzs1zDEFi.jpg" },
        display: false,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV1yXyaBGEVR.jpg" },
        display: false,
        description:
    ...
    },
    {
        ...
        img: { cover: "/animated_short_cover/BV14G1kB5Evp.jpg" },
        display: true,
        description:
